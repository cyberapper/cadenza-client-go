...
// checks if the ListTradingAccountOperations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTradingAccountOperations200Response{}

// ListTradingAccountOperations200Response struct for ListTradingAccountOperations200Response
type ListTradingAccountOperations200Response struct {
	...
	Data []AccountOperation `json:"data,omitempty"`
	Pagination *Pagination `json:"pagination,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ListTradingAccountOperations200Response ListTradingAccountOperations200Response
...
func NewListTradingAccountOperations200Response(errno int32) *ListTradingAccountOperations200Response {
	this := ListTradingAccountOperations200Response{}
	this.Errno = errno
	return &this
}
...
func (o *ListTradingAccountOperations200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ListTradingAccountOperations200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
// SetData gets a reference to the given []AccountOperation and assigns it to the Data field.
...
func (o ListTradingAccountOperations200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTradingAccountOperations200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTradingAccountOperations200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTradingAccountOperations200Response := _ListTradingAccountOperations200Response{}

	err = json.Unmarshal(data, &varListTradingAccountOperations200Response)

	if err != nil {
		return err
	}

	*o = ListTradingAccountOperations200Response(varListTradingAccountOperations200Response)
...
type NullableListTradingAccountOperations200Response struct {
	value *ListTradingAccountOperations200Response
	isSet bool
}

func (v NullableListTradingAccountOperations200Response) Get() *ListTradingAccountOperations200Response {
	return v.value
}

func (v *NullableListTradingAccountOperations200Response) Set(val *ListTradingAccountOperations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTradingAccountOperations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTradingAccountOperations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTradingAccountOperations200Response(val *ListTradingAccountOperations200Response) *NullableListTradingAccountOperations200Response {
	return &NullableListTradingAccountOperations200Response{value: val, isSet: true}
}

func (v NullableListTradingAccountOperations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTradingAccountOperations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
