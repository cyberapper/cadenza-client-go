...
// checks if the CreateTradingAccountCredential200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTradingAccountCredential200Response{}

// CreateTradingAccountCredential200Response struct for CreateTradingAccountCredential200Response
type CreateTradingAccountCredential200Response struct {
...
type _CreateTradingAccountCredential200Response CreateTradingAccountCredential200Response
...
func NewCreateTradingAccountCredential200Response(errno int32) *CreateTradingAccountCredential200Response {
	this := CreateTradingAccountCredential200Response{}
	this.Errno = errno
	return &this
}
...
func (o *CreateTradingAccountCredential200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *CreateTradingAccountCredential200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o CreateTradingAccountCredential200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateTradingAccountCredential200Response) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTradingAccountCredential200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTradingAccountCredential200Response := _CreateTradingAccountCredential200Response{}

	err = json.Unmarshal(data, &varCreateTradingAccountCredential200Response)

	if err != nil {
		return err
	}

	*o = CreateTradingAccountCredential200Response(varCreateTradingAccountCredential200Response)
...
type NullableCreateTradingAccountCredential200Response struct {
	value *CreateTradingAccountCredential200Response
	isSet bool
}

func (v NullableCreateTradingAccountCredential200Response) Get() *CreateTradingAccountCredential200Response {
	return v.value
}

func (v *NullableCreateTradingAccountCredential200Response) Set(val *CreateTradingAccountCredential200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTradingAccountCredential200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTradingAccountCredential200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTradingAccountCredential200Response(val *CreateTradingAccountCredential200Response) *NullableCreateTradingAccountCredential200Response {
	return &NullableCreateTradingAccountCredential200Response{value: val, isSet: true}
}

func (v NullableCreateTradingAccountCredential200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTradingAccountCredential200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
