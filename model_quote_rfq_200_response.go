...
// checks if the QuoteRfq200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuoteRfq200Response{}

// QuoteRfq200Response struct for QuoteRfq200Response
type QuoteRfq200Response struct {
...
type _QuoteRfq200Response QuoteRfq200Response
...
func (o *QuoteRfq200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QuoteRfq200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o QuoteRfq200Response) MarshalJSON() ([]byte, error) {
...
func (o QuoteRfq200Response) ToMap() (map[string]interface{}, error) {
...
func (o *QuoteRfq200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varQuoteRfq200Response := _QuoteRfq200Response{}

	err = json.Unmarshal(data, &varQuoteRfq200Response)

	if err != nil {
		return err
	}

	*o = QuoteRfq200Response(varQuoteRfq200Response)
...
type NullableQuoteRfq200Response struct {
	value *QuoteRfq200Response
	isSet bool
}

func (v NullableQuoteRfq200Response) Get() *QuoteRfq200Response {
	return v.value
}

func (v *NullableQuoteRfq200Response) Set(val *QuoteRfq200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableQuoteRfq200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableQuoteRfq200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuoteRfq200Response(val *QuoteRfq200Response) *NullableQuoteRfq200Response {
	return &NullableQuoteRfq200Response{value: val, isSet: true}
}

func (v NullableQuoteRfq200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuoteRfq200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
