...
type Root200Response struct {
	...
	Data *Root200ResponseAllOfData `json:"data,omitempty"`
}

type _Root200Response Root200Response
...
func (o *Root200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *Root200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o *Root200Response) GetData() Root200ResponseAllOfData {
	if o == nil || IsNil(o.Data) {
		var ret Root200ResponseAllOfData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given Root200ResponseAllOfData and assigns it to the Data field.
...
func (o *Root200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRoot200Response := _Root200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoot200Response)

	if err != nil {
		return err
	}

	*o = Root200Response(varRoot200Response)
