...
type _RpcPagination RpcPagination
...
func (o *RpcPagination) UnmarshalJSON(data []byte) (err error) {
	varRpcPagination := _RpcPagination{}

	err = json.Unmarshal(data, &varRpcPagination)

	if err != nil {
		return err
	}

	*o = RpcPagination(varRpcPagination)
