...
func (o *RpcSecurity) UnmarshalJSON(data []byte) (err error) {
	varRpcSecurity := _RpcSecurity{}

	err = json.Unmarshal(data, &varRpcSecurity)

	if err != nil {
		return err
	}

	*o = RpcSecurity(varRpcSecurity)
