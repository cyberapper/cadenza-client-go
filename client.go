...
// APIClient manages communication with the Algo724 Cadenza Fermata API API v3.0.1
...
type APIClient struct {
	...
	TradingAccountCredentialAPI TradingAccountCredentialAPI

	TradingAccountPortfolioAPI TradingAccountPortfolioAPI

	TradingAccountSubscriptionAPI TradingAccountSubscriptionAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.TradingAccountSubscriptionAPI = (*TradingAccountSubscriptionAPIService)(&c.common)
