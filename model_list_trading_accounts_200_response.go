...
// checks if the ListTradingAccounts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTradingAccounts200Response{}

// ListTradingAccounts200Response struct for ListTradingAccounts200Response
type ListTradingAccounts200Response struct {
...
type _ListTradingAccounts200Response ListTradingAccounts200Response
...
func NewListTradingAccounts200Response(errno int32) *ListTradingAccounts200Response {
	this := ListTradingAccounts200Response{}
	this.Errno = errno
	return &this
}
...
func (o *ListTradingAccounts200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ListTradingAccounts200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o ListTradingAccounts200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTradingAccounts200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTradingAccounts200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTradingAccounts200Response := _ListTradingAccounts200Response{}

	err = json.Unmarshal(data, &varListTradingAccounts200Response)

	if err != nil {
		return err
	}

	*o = ListTradingAccounts200Response(varListTradingAccounts200Response)
...
type NullableListTradingAccounts200Response struct {
	value *ListTradingAccounts200Response
	isSet bool
}

func (v NullableListTradingAccounts200Response) Get() *ListTradingAccounts200Response {
	return v.value
}

func (v *NullableListTradingAccounts200Response) Set(val *ListTradingAccounts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTradingAccounts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTradingAccounts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTradingAccounts200Response(val *ListTradingAccounts200Response) *NullableListTradingAccounts200Response {
	return &NullableListTradingAccounts200Response{value: val, isSet: true}
}

func (v NullableListTradingAccounts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTradingAccounts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
