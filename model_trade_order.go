...
// SetOrderListId gets a reference to the given string and assigns it to the OrderListId field.
...
func (o *TradeOrder) SetTakeProfitTimeInForceNil() {
...
func (o *TradeOrder) SetStopLossTimeInForceNil() {
