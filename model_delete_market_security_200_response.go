...
// checks if the DeleteMarketSecurity200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteMarketSecurity200Response{}

// DeleteMarketSecurity200Response struct for DeleteMarketSecurity200Response
type DeleteMarketSecurity200Response struct {
...
type _DeleteMarketSecurity200Response DeleteMarketSecurity200Response
...
func NewDeleteMarketSecurity200Response(errno int32) *DeleteMarketSecurity200Response {
	this := DeleteMarketSecurity200Response{}
	this.Errno = errno
	return &this
}
...
func (o *DeleteMarketSecurity200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *DeleteMarketSecurity200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o DeleteMarketSecurity200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteMarketSecurity200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteMarketSecurity200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteMarketSecurity200Response := _DeleteMarketSecurity200Response{}

	err = json.Unmarshal(data, &varDeleteMarketSecurity200Response)

	if err != nil {
		return err
	}

	*o = DeleteMarketSecurity200Response(varDeleteMarketSecurity200Response)
...
type NullableDeleteMarketSecurity200Response struct {
	value *DeleteMarketSecurity200Response
	isSet bool
}

func (v NullableDeleteMarketSecurity200Response) Get() *DeleteMarketSecurity200Response {
	return v.value
}

func (v *NullableDeleteMarketSecurity200Response) Set(val *DeleteMarketSecurity200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteMarketSecurity200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteMarketSecurity200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteMarketSecurity200Response(val *DeleteMarketSecurity200Response) *NullableDeleteMarketSecurity200Response {
	return &NullableDeleteMarketSecurity200Response{value: val, isSet: true}
}

func (v NullableDeleteMarketSecurity200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteMarketSecurity200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
