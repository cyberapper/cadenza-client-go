...
// checks if the GetMarketTicker200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarketTicker200Response{}

// GetMarketTicker200Response struct for GetMarketTicker200Response
type GetMarketTicker200Response struct {
...
type _GetMarketTicker200Response GetMarketTicker200Response
...
func NewGetMarketTicker200Response(errno int32) *GetMarketTicker200Response {
	this := GetMarketTicker200Response{}
	this.Errno = errno
	return &this
}
...
func (o *GetMarketTicker200Response) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *GetMarketTicker200Response) SetDetailsNil() {
	o.Details.Set(nil)
}
...
func (o GetMarketTicker200Response) MarshalJSON() ([]byte, error) {
...
func (o GetMarketTicker200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetMarketTicker200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMarketTicker200Response := _GetMarketTicker200Response{}

	err = json.Unmarshal(data, &varGetMarketTicker200Response)

	if err != nil {
		return err
	}

	*o = GetMarketTicker200Response(varGetMarketTicker200Response)
...
type NullableGetMarketTicker200Response struct {
	value *GetMarketTicker200Response
	isSet bool
}

func (v NullableGetMarketTicker200Response) Get() *GetMarketTicker200Response {
	return v.value
}

func (v *NullableGetMarketTicker200Response) Set(val *GetMarketTicker200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketTicker200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketTicker200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketTicker200Response(val *GetMarketTicker200Response) *NullableGetMarketTicker200Response {
	return &NullableGetMarketTicker200Response{value: val, isSet: true}
}

func (v NullableGetMarketTicker200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketTicker200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
